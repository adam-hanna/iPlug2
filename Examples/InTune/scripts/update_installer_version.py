...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=InTune Demo Installer\n"
      else:
        line="OutputBaseFilename=InTune Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the InTune Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the InTune installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=InTune Demo installer\n"
     else:
       line="SetupWindowTitle=InTune installer\n"
