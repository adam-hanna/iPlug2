...
def main():
  ...
  plistpath = scriptpath + "/resources/InTune-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InTune-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InTune-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InTune-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InTune-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/InTune.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/InTune.iss",inplace=1):
